        ...
        <main>
            <div class="buscador">
                <form action="" method="post" style="display: flex; width: 100%;">
                    <input type="search" name="buscar" autocomplete="off" placeholder="Buscar accesorios...">
            ...
            <div id="contenedor-productos" class="contenedor-productos">
                ...
                if ($listaProductos != null && count($listaProductos) > 0) {
                    ...
                    // Filtrar productos por categoría "Accesorios"
                    $productosAccesorios = array_filter($productosFiltrados, function ($producto) {
                        return $producto->getCategoriaProducto() === 'Accesorios';
                    });

                    // Filtrar productos por cantidad disponible mayor a 0
                    $productosAccesorios = array_filter($productosAccesorios, function ($producto) {
                        return $producto->getCantidad() > 0;
                    });

                    // Mostrar productos o mensaje si no hay resultados
                    if (count($productosAccesorios) > 0) {
                        ...
                        echo "No hay productos disponibles en la categoría de accesorios.";
                    }
                } else {
                    echo "No hay productos disponibles en la categoría de accesorios.";
                }
